...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_STEPS_PER_MM 62.75
  #define DEFAULT_Y_STEPS_PER_MM 62.75
  #define DEFAULT_Z_STEPS_PER_MM 400.0
  #define DEFAULT_X_MAX_RATE 3896.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 3896.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 916.8 // mm/min
  #define DEFAULT_X_ACCELERATION (150.0*60*60) // 150 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (150.0*60*60) // 150 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (50.0*60*60) // 50 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 770.0 // mm
  #define DEFAULT_Y_MAX_TRAVEL 690.0 // mm
  #define DEFAULT_Z_MAX_TRAVEL 42.0 // mm
